		...
		<div class="container">
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="index.html">ATN Company <span>Shop anywhere</span></a></h1>
				</div>
									...
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Male's Toy</h6>
												<li><a href="products.html">Toy 1</a></li>
												<li><a href="products.html">Toy 2</a></li>
												<li><a href="products.html">Toy 3</a></li>
												<li><a href="products.html">Toy 4</a></li>
												<li><a href="products.html">Toy 5</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Women's Toy</h6>
												<li><a href="products.html">Toy 6</a></li>
												<li><a href="products.html">Toy 7</a></li>
												<li><a href="products.html">Toy 8</a></li>
												<li><a href="products.html">Toy 9</a></li>
												<li><a href="products.html">Toy 10</a></li>
												<li><a href="products.html">Toy 11</a></li>
												<li><a href="products.html">Toy 12</a></li>
											</ul>
										</div>
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Play Sets</h6>
												<li><a href="products.html">Toy 13</a></li>
												<li><a href="products.html">Toy 14</a></li>
												<li><a href="products.html">Toy 15</a></li>
												<li><a href="products.html">Toy 16</a></li>
												<li><a href="products.html">Toy 17</a></li>
											</ul>
										</div>
										<div class="clearfix"></div>
									</div>
								...
								<ul class="dropdown-menu multi-column columns-3">
									<div class="row">
										...
										<li><a href="ConnectToDB.php">Connect database</a></li>
												<li><a href="InsertData.php">Insert data to the database</a></li>
												<li><a href="UpdateData.php">Update data to the database</a></li>
												<li><a href="DeleteData.php">Delete data to the database</a></li>
...
<!--typography-page -->
	...
	<center>	<div class="container">
			...
			<h3 class="title animated wow zoomIn" data-wow-delay=".5s">Register</h3>

				<form name="InsertData" action="register.php" method="POST" ></center>
				<li>Customer ID: </li><input type="text" name="customerid" />
						<li>Customer Name:</li><input type="text" name="customername" />
				<li>Customer Phone:</li><input type="text" name="customerphone" />
				<li>Address:</li><input type="text" name="address" /><br>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="footer-logo animated wow slideInUp" data-wow-delay=".5s">
				<h2><a href="index.html">ATN Company <span>shop anywhere</span></a></h2>
			</div>
			<div class="copy-right animated wow slideInUp" data-wow-delay=".5s">
				<p>&copy 2016 ATNCo. All rights reserved | Design by <a href="http://w3layouts.com/">W3layouts</a></p>
			</div>
		</div>
	</div>
<!-- //footer -->
